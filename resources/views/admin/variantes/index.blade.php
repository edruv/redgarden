...
@section('content')
	<div class="row mb-4 px-2">
		...
		<a href="{{ route('marcas.index') }}" class="col col-md-2 btn btn-sm blue accent-2 text-white"><i class="fa fa-folder"></i> Marcas</a>
						...
						<tbody class="sortable" data-table="Producto">
							@foreach ($products as $pro)
								<tr data-card="{{$pro->id}}">
									...
									<td class="align-middle">{{$pro->categoria->nombre}}</td>
									<td class="align-middle">{{$pro->marca->titulo}}</td>
									<td class="align-middle">
