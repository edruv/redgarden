...
@section('content')
	...
	<div class="row mb-4 px-2">
		<a href="{{ route('productos.variantes.show',$variante->id) }}" class="col col-md-2 btn btn-sm grey darken-2 text-white mr-auto"><i class="fa fa-reply"></i> Regresar</a>
	</div>
	<div class="col-12  mx-auto">
		<div class="card">
			<div class="card-body">
				<form action="{{route('productos.variantes.update',$variante->id)}}" method="post">
					@csrf
					@method('put')
					<div class="row">
						<div class="form-group text-center col-12 col-lg-6">
							...
							<select name="size" id="size" class="custom-select">
								...
								@foreach ($size as $s)
									<option @if ($variante->size == $s->id) selected @endif value="{{$s->id}}">{{$s->tamanio}}</option>
								@endforeach
							</select>
						</div>
						<div class="form-group text-center col-12 col-lg-6">
							...
							<select name="presentacion" id="presentacion" class="custom-select">
								...
								@foreach ($presentacion as $pres)
									<option @if ($variante->presentacion == $pres->id) selected @endif value="{{$pres->id}}">{{$pres->tamanio}}</option>
								@endforeach
							</select>
						</div>
						<div class="form-group text-center col-12 col-lg-6">
						...
						<div class="form-group text-center col-12 col-lg-6">
							...
							<input type="text" name="descuento" id="descuento" class="form-control" value="{{$variante->descuento}}" placeholder="%">
						</div>
					</div>
					...
					<div class=" text-center">
						<div class="row mx-auto">
							<div class="col-12 col-lg form-group">
								...
								<select name="tipo_envio" id="tipo_envio" class="form-control">
									<option selected nullable>Seleccionar</option>
						...
						<div class="row mx-auto">
							...
							<div class="col-12 col-lg-4 form-group">
								...
								<div class="input-group mb-2 mr-sm-2">
									<input type="text" class="form-control" id="ancho" name="ancho" value="{{ $variante->ancho }}" placeholder="Ancho">
									<div class="input-group-append">
										<div class="input-group-text">
											cm
										</div>
							...
							<div class="col-12 col-lg-4 form-group">
								...
								<div class="input-group mb-2 mr-sm-2">
									<input type="text" class="form-control" id="alto" name="alto" value="{{ $variante->alto }}" placeholder="Alto">
									<div class="input-group-append">
										<div class="input-group-text">
											cm
										</div>
