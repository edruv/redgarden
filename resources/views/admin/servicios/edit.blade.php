				...
				<form action="{{route('servicio.update',$servicio->id)}}" method="post">
					...
					<div class="row text-center">
						...
						<div class="col-md form-group">
							...
							<input type="text" name="nombre_en" id="nombre_en" class="form-control" value="{{ $servicio->nombre_en }}" required>
						</div>
					{{-- </div>
					...
					<div class="form-group text-center">
						...
						<textarea name="descripcion" id="descripcion" rows="10" class="texteditor form-control" style="resize:none;">{{ $servicio->descripcion }}</textarea>
					</div>
					<div class="form-group text-center">
						<label for="descripcion_en">Descripción (EN)</label>
						<textarea name="descripcion_en" id="descripcion_en" rows="10" class="texteditor form-control" style="resize:none;">{{ $servicio->descripcion_en }}</textarea>
					</div>
					<hr>
